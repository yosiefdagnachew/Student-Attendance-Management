...
namespace SAS.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Teacher_id,Teacher_fname,Teacher_lname,Phone_no,Email")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Teacher_id,Teacher_fname,Teacher_lname,Phone_no,Email")] Teacher teacher)
        {
