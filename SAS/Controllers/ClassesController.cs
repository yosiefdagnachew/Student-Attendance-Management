...
namespace SAS.Controllers
{
    public class ClassesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Class_id,Class_name,Building_number")] Class @class)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Class_id,Class_name,Building_number")] Class @class)
        {
        ...
        {
          return (_context.Class?.Any(e => e.Class_id == id)).GetValueOrDefault();
        }
    }
}
